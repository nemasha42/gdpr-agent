...
Routes:
    GET /                       — (via dashboard_bp)
    GET /company/<domain>       — (via company_bp)
    GET /cards                  — (via dashboard_bp)
    GET /data/<domain>          — (via data_bp)
    GET /refresh?account=EMAIL  — (via monitor_bp)
    GET /reextract?account=EMAIL — (via monitor_bp)
"""
