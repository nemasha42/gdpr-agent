...
def build_graph_data(rows: list[dict], companies_raw: dict | None = None, max_depth: int = 4) -> dict:
    ...
    Args:
        ...
        max_depth: maximum graph depth (default 4). Depth 0 = companies,
              depth 1 = direct subprocessors, depth 2+ = sub-subprocessors.
    Returns:
    ...
    if companies_raw and max_depth >= 2:
        ...
        while pending_sp and wave_depth <= max_depth:
