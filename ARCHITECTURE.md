...
The pipeline runs in five stages triggered by `run.py`, with a separate monitoring CLI (`monitor.py`) and a Flask dashboard that also drives portal automation and subprocessor disclosure requests. The dashboard uses an app factory pattern: `dashboard/__init__.py` provides `create_app()` (107 lines — Flask setup, LoginManager, all blueprint registration, before_request hook), `dashboard/shared.py` (573 lines) holds shared helpers and constants, and `dashboard/app.py` is the entry point (33 lines — creates the app via `create_app()` and runs it). All routes live in 10 blueprints under `dashboard/blueprints/` (2,832 lines total): `pipeline_bp.py` (831), `company_bp.py` (578), `transfers_bp.py` (385), `data_bp.py` (285), `portal_bp.py` (239), `dashboard_bp.py` (190), `monitor_bp.py` (90), `costs_bp.py` (89), `api_bp.py` (78), `settings_bp.py` (67). Service modules under `dashboard/services/` (1,520 lines total): `monitor_runner.py` (890), `graph_data.py` (395), `jurisdiction.py` (235). Total dashboard: ~5,630 lines across all Python files.
...
| `dashboard/` | App factory (`__init__.py`: `create_app()`, 107 lines), shared helpers & constants (`shared.py`, 573 lines), entry point (`app.py`, 33 lines), 10 route blueprints under `blueprints/` (2,832 lines): `pipeline_bp.py` (831), `company_bp.py` (578), `transfers_bp.py` (385), `data_bp.py` (285), `portal_bp.py` (239), `dashboard_bp.py` (190), `monitor_bp.py` (90), `costs_bp.py` (89), `api_bp.py` (78), `settings_bp.py` (67). Service modules under `services/` (1,520 lines): `monitor_runner.py` (890), `graph_data.py` (395), `jurisdiction.py` (235). Support modules: `auth_routes.py` (203), `user_model.py` (128), `tasks.py` (81), `scan_state.py` (62), `admin_routes.py` (59), `sse.py` (32). Jinja2 templates, static JS/CSS. Total: ~5,630 lines |
